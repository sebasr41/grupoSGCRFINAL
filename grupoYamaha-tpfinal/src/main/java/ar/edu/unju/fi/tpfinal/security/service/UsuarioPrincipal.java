package ar.edu.unju.fi.tpfinal.security.service;
...
public class UsuarioPrincipal implements UserDetails {
    ...
    public static UsuarioPrincipal build(Usuario usuario){ // pasamos los roles convertidos en grantedAuthorities
